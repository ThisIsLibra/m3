...
/**
 * The configuration file for Cerberus, which implements the IConfig interface
 * and the abstract Config class. The abstract class contains all generic
 * fields, meaning only additional values are required to be stored in this
 * class.
 *
 * @author Max 'Libra' Kersten [@Libranalysis, https://maxkersten.nl]
 */
public class CerberusConfig extends Config implements IConfig {
    ...
    /**
     * The Cerberus ID, which is a 17 character long string (based on
     * [a-z0-9]{17}) that is generated when the configuration is created
     */
    private String id;

    /**
     * Creates a Cerberus bot based on the given data
     *
    ...
    /**
     * Gets the Cerberus ID, which is a 17 character long string (based on
     * [a-z0-9]{17}) that is generated when the configuration is created
     *
     * @return the ID
     */
